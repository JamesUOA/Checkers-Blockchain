...
export class QueryClientImpl {
    ...
    Params(request) {
        ...
        const promise = this.rpc.request("jamesuoa.checkers.checkers.Query", "Params", data);
        return promise.then((data) => QueryParamsResponse.decode(new Reader(data)));
    }
    NextGame(request) {
        const data = QueryGetNextGameRequest.encode(request).finish();
        const promise = this.rpc.request("jamesuoa.checkers.checkers.Query", "NextGame", data);
    ...
    StoredGame(request) {
        ...
        const promise = this.rpc.request("jamesuoa.checkers.checkers.Query", "StoredGame", data);
    ...
    StoredGameAll(request) {
        ...
        const promise = this.rpc.request("jamesuoa.checkers.checkers.Query", "StoredGameAll", data);
    ...
    CanPlayMove(request) {
        ...
        const promise = this.rpc.request("jamesuoa.checkers.checkers.Query", "CanPlayMove", data);
