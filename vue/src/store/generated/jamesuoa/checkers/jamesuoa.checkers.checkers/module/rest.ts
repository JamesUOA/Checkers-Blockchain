...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/jamesuoa/checkers/checkers/can_play_move/{idValue}/{player}/{fromX}/{fromY}/{toX}/{toY}
   */
  queryCanPlayMove = (
    idValue: string,
    player: string,
    ...
    this.request<CheckersQueryCanPlayMoveResponse, RpcStatus>({
      path: `/jamesuoa/checkers/checkers/can_play_move/${idValue}/${player}/${fromX}/${fromY}/${toX}/${toY}`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/jamesuoa/checkers/checkers/next_game
   */
  queryNextGame = (params: RequestParams = {}) =>
    this.request<CheckersQueryGetNextGameResponse, RpcStatus>({
      path: `/jamesuoa/checkers/checkers/next_game`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/jamesuoa/checkers/checkers/params
   */
  queryParams = (params: RequestParams = {}) =>
    this.request<CheckersQueryParamsResponse, RpcStatus>({
      path: `/jamesuoa/checkers/checkers/params`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/jamesuoa/checkers/checkers/stored_game
   */
  queryStoredGameAll = (
    query?: {
    ...
    this.request<CheckersQueryAllStoredGameResponse, RpcStatus>({
      path: `/jamesuoa/checkers/checkers/stored_game`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
